...
export default function About(props) {
  ...
  let myStyle = {
    ...
    backgroundColor : props.mode === 'dark' ? '#5f6163' : 'white'
  }

    // let [myStyle , setmySyle] = useState({
    //     color: "black",
...
{/* <button onClick={toggleClick} className="btn btn-primary my-3 mx-3">{btnText}</button> */}
    </div>
  )
}
